...
import { SavedObjectFinder, SavedObjectMetaData } from 'ui/saved_objects/components/saved_object_finder';
      ...
      <EuiFlyout ownFocus onClose={this.props.onClose} data-test-subj="dashboardAddPanel">
        <EuiFlyoutHeader hasBorder>
          <EuiTitle size="m">
            <h2>
              <FormattedMessage
                id="kbn.embeddables.addPanelsTitle"
        ...
        <EuiFlyoutBody>
          <SavedObjectFinder
            ...
            savedObjectMetaData={Object.values(embeddableFactories.getFactories())
              ...
              .map(({ savedObjectMetaData }) => savedObjectMetaData) as SavedObjectMetaData<SavedObjectAttributes>[]}
            showFilter={true}
            noItemsMessage={i18n.translate(
              'kbn.embeddables.addPanel.noMatchingObjectsMessage',
              {
          ...
          <EuiFlexGroup justifyContent="flexEnd">
            <EuiFlexItem grow={true}>
              <EuiSuperSelect
                ...
                options={[
                  {
                    inputDisplay: i18n.translate('kbn.embeddables.addPanel.createNewDefaultOption', {
