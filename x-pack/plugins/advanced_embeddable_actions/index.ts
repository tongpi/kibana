...
export const advancedEmbeddableActions = (kibana: any) => {
  return new kibana.Plugin({
    ...
    uiExports: {
      ...
      embeddableFactories: [
        'plugins/advanced_embeddable_actions/user_embeddable/user_embeddable_factory',
        'plugins/advanced_embeddable_actions/users_embeddable/users_embeddable_factory',
      ],
    },
  });
};
